...
export function FuturePlansSection() {
    const plans: FuturePlan[] = [
        ...
        },
        {
            ...
            icon: Atom,
            areas: ['Quantum Algorithms', 'Quantum ML', 'Quantum Cryptography', 'Optimization'],
        },
        {
            ...
            icon: Code2,
            areas: ['System Architecture', 'Performance Optimization', 'Defense Tech', 'Innovation'],
        },
    ];
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-foreground/90 max-w-3xl mx-auto leading-relaxed">
                            I'm at an exciting crossroads with multiple compelling paths ahead. Whether pursuing
                            cutting-edge research in academia or continuing to innovate in the software
                            development industry, my goal is to push the boundaries of technology and contribute
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {plans.map((plan, index) => (
                            <motion.div
                                key={index}
                                className="group p-6 rounded-lg border relative overflow-hidden glass-morphism border-primary/20 hover:shadow-[0_0_30px_rgba(0,217,255,0.3)] transition-all duration-300"
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
