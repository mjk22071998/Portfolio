...
export function OpenSourceSection() {
  const contributions: Contribution[] = [
    ...
    },
    {
      ...
      badge:
        "https://static.pepy.tech/personalized-badge/collapsiblepane?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {contributions.map((contrib, index) => (
              ...
              >
                ...
                {contrib.badge && (
                  <a href="https://pepy.tech/projects/collapsiblepane">
                    <img
                      src="https://static.pepy.tech/personalized-badge/collapsiblepane?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads"
                      alt="PyPI Downloads"
                    />
                  </a>
                )}
